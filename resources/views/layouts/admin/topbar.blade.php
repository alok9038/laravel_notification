        ...
        <ul class="list-unstyled topbar-nav float-end mb-0">
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-bs-toggle="dropdown"
                    ...
                    <img src="http://127.0.0.1:8080/assets/images/users/user-1.jpg" alt="profile-user"
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <form id="logout-form" action="http://127.0.0.1:8080/logout" method="POST"
                        style="display: none;">
                        <input type="hidden" name="_token" value="3GBgXSt5OEXdD5Pu38dAwnKDdAhteRsHB9iD0paE">
                    </form>
                </div>
            </li>
        </ul>
